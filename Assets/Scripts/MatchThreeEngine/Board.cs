...
namespace MatchThreeEngine
{
	public sealed class Board : MonoBehaviour
	{
        ...
        [SerializeField] private DisplayVariables displayVariables;
		[SerializeField] private Rounds round;
		...
		private void Start()
		{
			foreach(TileTypeAsset tile in tileTypes)
			{
				tile.value = 1;
			}
            ...
            OnMatch += (type, count) =>
            {
                ...
                displayVariables.Add(type.id, type.value * count);
            };
        }
